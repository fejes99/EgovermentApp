...
import {
  ...
  getCityRooms,
  getCityAppointments,
  getAllReissuanceServices,
  createAppointment,
} from 'wasp/client/operations';
import Scheduler from '../components/Scheduler/Scheduler';
import ModalAddAppointment from '../components/modals/ModalAddAppointment';

const AppointmentReissuancePage: React.FC = () => {
  const history = useHistory();

  const { data: user } = useAuth();
  const { data: services } = useQuery(getAllReissuanceServices);
...
export default AppointmentReissuancePage;
